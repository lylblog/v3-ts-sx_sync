<template>
  <div>
      <logout v-if="$route.meta.isShow"></logout>
    <nav v-if="$route.meta.isShow">   <!--    配合路由文件中meta: { isShow: false/true},判断哪些页面显示导航栏-->
      <!-- 路由导航-->
      <!--  <router-link to="/login">登录</router-link> -->
      <router-link to="/login_new">登录</router-link>
      ...
      <router-link to="/logout">退出页</router-link>
    </nav>
    <div class="container">
      <!-- 路由出口 -->
      <!-- 路由匹配到的组件将渲染在这里 -->
