...
<!--        </el-breadcrumb>-->
        ...
        <el-card>
            ...
            <!-- 添加用户的对话框 -->
            <el-dialog v-model="addDialogVisible" title="添加用户" width="50%" @close="addDialogClose" >
                <!-- 内容主体区域 -->
...
export default {
    ...
    methods: {
        ...
        userStateChanged (userinfo) {
            axios.put(`/user/${userinfo.id}/state/${userinfo.mg_state}`,)
                .then((res) => {
                    userinfo.mg_state = !userinfo.mg_state
                    return this.$message.error('更新用户状态失败')
                    // console.log(total);
                })
            return this.$message.error('更新用户状态成功')
        },
        // 监听用户Dialog （对话框） 的关闭事件
        addDialogClose () {
